...
tab_caption,tab_music,tab_shorts,tab_t2i,tab_logo,tab_dub,tab_srt=st.tabs(
    ["🎬 Auto Caption","🎵 Background Music","✂️ YouTube Shorts","🖼️ Text to Image","🏷️ Add Logo","🌏 Dịch & Dubbing","📄 SRT → Dubbing"])
