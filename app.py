...
# ─────────────────────────────────────────────
# ── Pollinations.ai — 100% free, no API key, no credits ──
POLLINATIONS_URL = "https://image.pollinations.ai/prompt/{prompt}"

T2I_MODELS = {
    "flux (Chất lượng cao, mặc định)":      "flux",
    "flux-realism (Ảnh thực tế)":           "flux-realism",
    "flux-anime (Anime/Illustration)":      "flux-anime",
    "flux-3d (3D / Render)":                "flux-3d",
    "turbo (Nhanh nhất)":                   "turbo",
}
...
def generate_images(model_id: str,
    ...
    """
    Generate images via Pollinations.ai — 100% free, no API key, no credits.
        ...
        for attempt in range(3):
            try:
                ...
                if attempt < 2:
                    ...
                    raise RuntimeError("Timeout sau 3 lần thử")
...
with tab_t2i:
    ...
    with col_set:
        # ── HF Token ─────────────────────────────
        st.success("✅ Pollinations.ai — Miễn phí hoàn toàn, không cần API key!")
        ...
        with st.expander("ℹ️ Về Pollinations.ai"):
            st.markdown("""
**Pollinations.ai** là dịch vụ text-to-image hoàn toàn miễn phí:
- ✅ Không cần API key
- ✅ Không có giới hạn credits tháng
- ✅ Hỗ trợ FLUX, Turbo, Anime, 3D
- ✅ Không watermark
