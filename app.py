...
T2I_MODELS = {
    "FLUX Schnell Free (Nhanh, miễn phí)":        "black-forest-labs/flux-schnell:free",
    "FLUX 1.1 Pro (Sắc nét, chi tiết cao)":       "black-forest-labs/flux-1.1-pro",
    "FLUX 1.1 Pro Ultra (Chất lượng tốt nhất)":   "black-forest-labs/flux-1.1-pro:ultra",
    "Gemini 2.5 Flash Image (Google)":             "google/gemini-2.5-flash-preview:thinking",
    "Recraft V3 (Illustration/Design)":            "recraft-ai/recraft-v3",
}
...
with tab_t2i:
    ...
    with col_set:
        ...
        # Highlight free model
        if "free" in model_id.lower():
            st.success("✅ Model này miễn phí!")
        else:
            st.caption("💳 Model trả phí — kiểm tra giá tại openrouter.ai/models")
