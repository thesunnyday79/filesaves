...
# PIPELINE
# ─────────────────────────────────────────────
def process_video(sess, groq_key, video_info, log_ph, prog_ph):
    logs = []
...
# ── Two feature tabs ───────────────────────────
tab_caption, tab_music = st.tabs(["🎬 Auto Caption", "🎵 Background Music"])
...
with tab_caption:
    ...
    with left:
        st.subheader("Chọn video để caption")
    ...
    with right:
        ...
        if "cap_queue" in st.session_state:
            ...
            <div style="text-align:center;padding:3rem 1rem;color:#555">
                ...
                <div style="margin-top:0.8rem">Chọn video và nhấn <b>Tạo Caption</b></div>
